...
@section('content')
        <main class="wrapper project-create projects-search-v2">
            ...
            <div class="dashboard-wrapper ">
                ...
                <div class="project-create-wrap">
                        ...
                        <div class="project-create__top">
                            ...
                            <div class="project-create__top-right">
                                <div class="project-create__top-right-top">
                                    ...
                                    <a href="{{url()->current()}}?view-projects=1" class="project-create__top-right-send btn--solid btn--arrow  btn">Check projects</a>
                    ...
                    @if($data['open_projects'])
                        ...
                        <div class="projects-wrapper centre-posit">
                            ...
                            @foreach($data['projects'] as $key => $val)
                                ...
                                <div class="project__item">
                                    <div class="project__item-wrap">
                                        <div class="project__img"><img src="{{isset($val->photo_project) ? asset($val->photo_project) : asset('img/project-img.webp') }}" alt="Project image"></div>
                ...
                <div class="project-preview__wrap project-preview__wrap--page">
                    <div class="project-preview__popup project-preview__popup--page">
                        ...
                        <div class="project-preview__content">
                            <div class="project-preview__img"><img class="pr-photo-project" src="{{asset('img/project-img-full.webp')}}" alt="Project img"></div>
                            <div class="project-preview__text">
                                ...
                                <div class="project-preview__author">
                                    <div class="project-preview__author-img"><img class="pr-user-photo" src="{{asset('img/user-2.webp')}}" alt="User"></div>
                                    <div class="project-preview__author-title">
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                $(document).ready(function () {
                    ...
                    $('.project-preview__popup .nav__back').click(function(){
                        ...
                        $('.project-create-wrap').css('display', 'block')
                    })
                    ...
                    $(document).on('click', '.counter-project-view', function(event) {
                        ...
                        $('.project-create-wrap').css('display', 'none')
