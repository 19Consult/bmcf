<div class="sidebar admin-panel">
    ...
    <a href="#" style="display: none"><img src="{{asset("img/icons/icon-cupcake.svg")}}" alt="Cupcake" /></a>
    ...
    <a href="{{route("admin.adminSettingsPage")}}">
        <img src="{{asset("img/icons/profile 1.svg")}}" alt="User" />
        <span>Admin</span>
    </a>
